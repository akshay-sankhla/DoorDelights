...
public class RestaurantServiceImpl implements RestaurantService {
     ...
     * @param favourite - Favorite type object received containing emailid and Restaurant to be added to favorite list of
    ...
    public Favourite addToFavourites(Favourite favourite) throws FavouriteAlreadyExistsException {
        ...
        if(favouriteResult.isPresent()) {
            ...
            favouriteResult.get().getRestaurant().add(favourite.getRestaurant().get(0));
     ...
     * @param id - type String variable for finding specific restaurant from user's favorite list.
     * @return - returns favorite restaurant list of user with email in case of success.
     * @throws RuntimeException - throws FavouriteListDoesNotExistsException in case the requested favourite list
     *          does not exists and FavouriteDoesNotExistsException in case the requested restaurant does not exists in
